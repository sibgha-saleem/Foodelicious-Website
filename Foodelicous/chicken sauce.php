...
if(isset($_SESSION['login_user']))
    ...
    <div id="recipe_container">
      <img src="img/chicken sauce.jpeg" style="width: 100%" />
    </div>

    <div id="recipes_r">
      <h1 id="home_h1">Grilled Chicken With Sauce Recipe</h1>
    </div>
    ...
    <div id="recipe">
      ...
      <ul id="r_ul2">
        <li id="r_li">3 tablespoons vegetable oil</li>
        <li id="r_li">1 teaspoon salt</li>
        <li id="r_li">1 teaspoon black pepper</li>
        <li id="r_li">1 teaspoon red chill powder</li>
        <li id="r_li">1 teaspoon cayenne</li>
        <li id="r_li">1 tablespoon garam masala</li>
        <li id="r_li">1 tablespoon paprika</li>
        <li id="r_li">2 teaspoon mayonaise</li>
        <li id="r_li">1 tablespoons hot sauce</li>
        <li id="r_li">0.5 teaspoon mustard sauce</li>
        <li id="r_li">
          2 whole chicken leg quarters (drumsticks and thighs), skinless,
          bone-in
        </li>
      </ul>
      ...
      <ul id="r_ul2">
        <li id="r_li">
          Marinate the chicken with the dry ingredients and let it rest for 10
          mins.
        </li>
        <li id="r_li">Heat the Grill</li>
        <li id="r_li">
          Cook the chicken on medium-low flame for about 10 mins on both sides
        </li>
        <li id="r_li">For sauce mix mayonais, mustard and hot sauce.</li>
        <li id="r_li">Serve Grilled Chicken with prepared sauce.</li>
      </ul>
    </div>
...
<form id="asd" method="post" action="commentAction.php" style="text-align:center;">
  <input type="hidden" name="table" value="sauce">
...
<input type="hidden" name="recipes" value="Grilled Chicken with Sauce">
