...
if(isset($_SESSION['login_user']))
    ...
    <div id="recipe_container">
      <img src="img/grilled.jpeg" style="width: 100%; " />
    </div>

    <div id="recipes_r">
      <h1 id="home_h1">Grilled Vegetables Recipe</h1>
    </div >
    ...
    <div id="recipe">
      ...
      <ul id="r_ul2">
        ...
        <li id="r_li">1 teaspoon chilli powder</li>
        <li id="r_li">1 Tomato thick sliced</li>
        <li id="r_li">1 Onion sliced</li>
        <li id="r_li">1 eggplant sliced</li>
        <li id="r_li">2-3 chillies</li>
        <li id="r_li">2 tablespoons lemon juice</li>
        <li id="r_li">1 zuchinni sliced</li>
        <li id="r_li">
      ...
      <ul id="r_ul2">
        <li id="r_li">Marinate the vegetables with spices and lemon juice</li>
        <li id="r_li">
          Heat the grill and drizzle oil.              </li>
        <li id="r_li">
          Grill the vegetable on high flame for 2-3 mins on each side
        </li>
        <li id="r_li">Serve</li>
    </div> 
...
<form id="asd" method="post" action="commentAction.php" style="text-align:center;">
  <input type="hidden" name="table" value="grilled">
...
<input type="hidden" name="recipes" value="Grilled Vegetables">
