...
if(isset($_SESSION['login_user']))
    ...
    <div id="recipe_container">
      <img src="img/pink pasta.jpg" style="width: 100%; " />
    </div>

    <div id="recipes_r">
      <h1 id="home_h1">Pink Sauce Pasta Recipe</h1>
        <div >
          ...
          <div id="recipe">
            ...
            <ul id="r_ul2">
              <li id="r_li">Boil pasta and set aside</li>
              <li id="r_li">
                Blend 2 tomatos add in pan along with chicken and cook for 5 mins. Then add spices in it.
              </li>
              <li id="r_li">
                Now prepare white Sauce. Add butter in pan, then 1 tablespoon maida and cook for 2 mins in low flame. Gradually add milk, stir constantly and spices.
              </li>
              <li id="r_li">Add white sauce and pasta to chicken and tomato mixture and mix well.</li>
              <li id="r_li">
                Serve.
              </li>
...
<form id="asd" method="post" action="commentAction.php" style="text-align:center;">
  <input type="hidden" name="table" value="pasta">
...
<input type="hidden" name="recipes" value="Pink Sauce Pasta">
