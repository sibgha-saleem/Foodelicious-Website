...
if(isset($_SESSION['login_user']))
    ...
    <div id="recipe_container">
      <img src="img/wraps.jpeg" style="width: 100%;" />
    </div>

    <div id="recipes_r">
      <h1 id="home_h1">Tortilla Wraps Recipe</h1>
    </div >
          ...
          <div id="recipe">
            ...
            <ul id="r_ul2">
              ...
              <li id="r_li">1 teaspoon black pepper powder</li>
              <li id="r_li">1 teaspoon chilli powder</li>
              <li id="r_li">1 teaspoon oregano</li>
              <li id="r_li">3 Tortilla wraps</li>
              <li id="r_li">Mayonnaise</li>
              <li id="r_li">Hot sauce</li>
              <li id="r_li">200g boneless chicken
              </li>
            </ul>
      
            <h1 class="h1_r">Method</h1>
            <ul id="r_ul2">
              <li id="r_li">Marinate the Chicken and grill for 10 mins on low-medium flame.</li>
              <li id="r_li">
                Heat the wraps spread Mayonnaise and hot sauce, then add cooked chicken and wrap it up.             </li>
              <li id="r_li">
                Grill the wrap on low flame for 1-2 mins on each side.
              </li>
              <li id="r_li">Serve</li>
          </div> 
...
<form id="asd" method="post" action="commentAction.php" style="text-align:center;">
  <input type="hidden" name="table" value="wraps">
...
<input type="hidden" name="recipes" value="Tortilla Wraps">
