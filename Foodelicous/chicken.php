...
if(isset($_SESSION['login_user']))
    ...
    <div id="recipe_container">
      <img src="img/tandoori.jpg" style="width: 100%" />
    </div>

    <div id="recipes_r">
      <h1 id="home_h1">Chicken Tandoori Recipe</h1>
    </div>
    ...
    <div id="recipe">
      ...
      <ul id="r_ul2">
        ...
        <li id="r_li">1 teaspoon ground coriander</li>
        <li id="r_li">1 teaspoon ground cumin</li>
        <li id="r_li">1 teaspoon ground turmeric</li>
        <li id="r_li">1 teaspoon cayenne</li>
        <li id="r_li">1 tablespoon garam masala</li>
        <li id="r_li">1 tablespoon sweet (not hot) paprika</li>
        <li id="r_li">1 cup plain yogurt (can sub buttermilk)</li>
        <li id="r_li">2 tablespoons lemon juice</li>
        <li id="r_li">4 garlic cloves, minced</li>
        <li id="r_li">
          4 whole chicken leg quarters (drumsticks and thighs), skinless,
          bone-in
        </li>
      </ul>
      ...
      <ul id="r_ul2">
        <li id="r_li">Heat the spices in oil</li>
        <li id="r_li">
        ...
        <li id="r_li">Prepare grill</li>
        <li id="r_li">
          Shake off excess marinade, place chicken on hot side of grill
        </li>
        <li id="r_li">Move to cool side of grill, cover and cook</li>
      </ul>
    </div>
...
<form id="asd" method="post" action="commentAction.php" style="text-align:center;">
  <input type="hidden" name="table" value="chicken">
...
<input type="hidden" name="recipes" value="Smoked Chicken Tandoori">
<label class="h1_r" style="margin-left:30%;">If you want to place order, press </label>
<button type="submit" name="order" value="Add Comment" style=" background-color: white;
  ...
  padding:10px">Order</button>
    ...
    <div id="featuredrecipes" style="clear: both">
      ...
      >
      <a href="grilled.php">
        <div class="r2" style="clear: right">
