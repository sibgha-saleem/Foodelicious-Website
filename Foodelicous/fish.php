...
if(isset($_SESSION['login_user']))
    ...
    <div id="recipe_container">
      <img src="img/fish.jpeg" style="width: 100%; " />
    </div>

    <div id="recipes_r">
      <h1 id="home_h1">Fish and Chips Recipe</h1>
        <div >
          <div id="recipe">
            <ul id="r_ul">
              <li id="r_li">
            ...
            <ul id="r_ul2">
              ...
              <li id="r_li">1 tablespoon black pepper</li>
              <li id="r_li">1 tablespoon soy sauce</li>
              <li id="r_li">1/2 cup maida</li>
              <li id="r_li">1 cup breadcrumbs</li>
              <li id="r_li">2 tablespoons lemon juice</li>
              <li id="r_li">1 egg</li>
              <li id="r_li">
                250g boneless finger fish
              </li>
            </ul>
      
            <h1 class="h1_r">Method</h1>
            <ul id="r_ul2">
              <li id="r_li">Marinate the fish with spices, soy sauce and lemon juice.</li>
              <li id="r_li">
                Whisk 1 egg.
              </li>
              <li id="r_li">
                Coat fish in maida first, then in egg and afterwards in breadcrumbs
              </li>
              <li id="r_li">Fry them in low flame on 5 mins each side</li>
              <li id="r_li">
                Serve with Chips.
              </li>
            </ul>
...
<form id="asd" method="post" action="commentAction.php" style="text-align:center;">
  <input type="hidden" name="table" value="fish">
...
<input type="hidden" name="recipes" value="Fish and Chips">
