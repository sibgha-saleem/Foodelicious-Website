...
if(isset($_SESSION['login_user']))
    ...
    <div id="recipes_r">
      <h1 id="home_h1">Potato Cutlets Recipe</h1>
        <div >
          ...
          <div id="recipe">
            ...
            <ul id="r_ul2">
              ...
              <li id="r_li">1 teaspoon chopped mint</li>
              <li id="r_li">1 chopped onion</li>
              <li id="r_li">1 tablespoon red Chilli powder</li>
              <li id="r_li">2 tablespoon curshed coriander leaves</li>
              <li id="r_li">3-4 mashed potatoes</li>
              <li id="r_li">1 egg</li>
              <li id="r_li">
                1 cup breadcrumbs
              </li>
            ...
            <ul id="r_ul2">
              <li id="r_li">Add spices and vegatables in mashed potatoes and shape them into kabaab.</li>
              <li id="r_li">
                Coat in egg then in breadcrumbs and set aside.
              </li>
              <li id="r_li">
                Shallow fry them on medium flame for 5 mins on each side.
              </li>
              <li id="r_li">Serve</li>
            </ul>
          </div>
...
<form id="asd" method="post" action="commentAction.php" style="text-align:center;">
  <input type="hidden" name="table" value="potato">
...
<input type="hidden" name="recipes" value="Potato Cutlets">
